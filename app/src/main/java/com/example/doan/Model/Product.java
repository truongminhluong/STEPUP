...
public class Product implements Serializable {
    ...
    public Product(String id, String name, String code, long price, String brand, String description, boolean status, boolean hasVariation, int quantity, String imageUrl, String category, boolean bestSeller, boolean favorite, List<ProductVariant> variants) {
        this.id = id;
        this.name = name;
        this.code = code;
        this.price = price;
